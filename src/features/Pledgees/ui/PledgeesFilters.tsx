...
export function PledgeesFilters({
  period,
  searchFio,
  type,
  onPeriodChange,
  ...
  return (
    <div className="flex gap-4 my-4 bg-white/70 p-5 rounded-[5px]">
      ...
      <div className="flex items-center gap-2">
        <Input
          type="text"
          placeholder="Поиск по залогодержателю"
      ...
      <div className="flex items-center gap-2 ">
        <Select value={localType} onValueChange={handleTypeChange}>
          <SelectTrigger className="min-w-24 bg-white border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
